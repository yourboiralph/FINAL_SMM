    ...
    <div class="mt-6 bg-white p-4 rounded-md shadow-md w-fit">
        <div class="flex justify-between">
            ...
            <div class="flex space-x-2">
                <button id="useUpload" class="px-2 border rounded {{ Auth::user()->signature ? '' : 'bg-gray-200' }}" {{ $isSigned ? 'disabled' : '' }}>
                ...
                <button id="useSavedSignature" class="px-2 border rounded {{ Auth::user()->signature ? 'bg-gray-200' : 'bg-gray-300' }}" {{ $isSigned ? 'disabled' : '' }}>
        ...
        <form action="{{ url('/operation/update/' . $job_draft->id) }}" method="POST"
            ...
            <div id="savedPadSection" class="{{ Auth::user()->signature ? '' : 'hidden' }}">
                ...
                <div class="mt-2 flex">
                    ...
                    <input type="hidden" name="new_signature_pad" id="savedSignatureData" value="{{ asset(Auth::user()->signature) }}">
                </div>
            </div>
            ...
            <div class="mt-4 flex space-x-4">
                ...
                <a href="{{ url('/operations/decline/' . $job_draft->id) }}">
                    <button type="button"
