            ...
            <div class="" >
                ...
                <div class="h-auto gap-8 m-10 p-10 relative bg-white " style="box-shadow: 0 20px 30px -5px rgba(0, 0, 0, 0.3); border-radius: 8px;">
                    <div class="rounded-md text-white flex justify-end mb-10">
                        <a href="{{ url('/topmanager') }}" class="w-fit px-4 py-1 bg-[#fa7011] rounded hover:bg-[#d95f0a] transition duration-200">
                            Back
                        </a>
                    </div>
                    ...
                    <div class="flex gap-8">
                        ...
                        <div>
                            <ul class="space-y-4">
                                ...
                                <li class="max-h-[500px] overflow-y-auto">{!! $job_draft->draft !!}</li>
                    ...
                    <div class="mt-10">
                        <form action="{{url('/topmanager/decline/' . $job_draft->id)}}" method="POST">
                            @csrf
